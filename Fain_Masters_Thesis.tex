...
\title{Applying desktop GPUs to a hybrid ABM and PDM: model validation and rapid simulation of viral infections}           % Title of dissertation or thesis
...
\frontmatter 
\acknowledgements{TextBlock/acknowledgments}
\tableofcontents
\clearpage \listoffigures
\clearpage \listoftables	
\clearpage \abbreviations{TextBlock/abbreviations} %list of abvs.

\mainmatter
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Remove the following \input commands and change them to the files containing the text of your document
